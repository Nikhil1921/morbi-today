...
class PaperCategory extends MY_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->redirect = admin("paperCategory");
	}

	private $name = 'paper_category';
    private $title = 'e paper category';
    private $table = "paper_category";
	...
	public function get()
    {
        $fetch_data = $this->main->make_datatables('paper_category_model');
        $sr = $_POST['start'] + 1;
        $data = array();
        ...
        $output = array(  
            ...
            "recordsFiltered"   => $this->main->get_filtered_data('paper_category_model'),
            "data"              => $data,
            $csrf_name          => $csrf_hash
        );
