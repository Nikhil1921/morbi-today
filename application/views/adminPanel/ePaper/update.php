        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select name="cat_name" id="cat_name" class="form-control">
              ...
              <option value="<?= $c['id'] ?>" <?= ($c['id'] == $data['cat_id']) ? 'selected' : '' ?>><?= $c['cat_name'] ?></option>
              <?php endforeach ?>
            </select>
            <?= form_error('cat_name') ?>
          </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group date" id="paper_date" data-target-input="nearest">
              <input type="text" name="paper_date" class="form-control datetimepicker-input" data-target="#paper_date" data-toggle="datetimepicker" value="<?= date('m/d/Y', $data['paper_date']) ?>">
            </div>
