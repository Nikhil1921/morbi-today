						...
						<div class="grid-box">
							...
							<div style="text-align:center;">
								<div style="display:none;margin:0 auto;" class="html5gallery" data-skin="vertical" data-width="400" data-height="225" data-resizemode="fill">
									...
									<?php endif ?>
									<?php foreach ($this->main->getall('video', 'id, name, link', ['is_deleted' => 0], 'id DESC') as $vid): $img = explode('/', $vid['link']) ?>
									<a href="<?= $vid['link']; ?>">
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="video-post">
										...
										<!-- <iframe width="245" height="250" src="<?= $vid['link']; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
									</div>
								</div>
								<?php endforeach ?>
							</div>
